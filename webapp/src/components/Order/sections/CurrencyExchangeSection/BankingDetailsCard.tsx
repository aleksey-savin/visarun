...
const BankingDetailsCard = ({
    ...
    const [cardOrPhoneNumber, setCardOrPhoneNumber] = useState(existingBankingDetails?.content?.split("|")[1] || "");
    const [holderName, setHolderName] = useState(existingBankingDetails?.content?.split("|")[2] || "");
    const [holderSurname, setHolderSurname] = useState(existingBankingDetails?.content?.split("|")[3] || "");

    const handleOnBlur = () => {
        saveBankingDetails(bankingDetailsType, bankName, cardOrPhoneNumber, holderName, holderSurname, "");
    }
