    ...
    return (
      <div className="container mx-auto py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading visa type...</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          <CardTitle>Edit Visa Type</CardTitle>
          <p className="text-sm text-muted-foreground">Update visa type information</p>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-3">
              ...
              <Button type="submit" disabled={isSubmitting}>
                ...
                {isSubmitting ? 'Updating...' : 'Update Visa Type'}
              </Button>
            </div>
          </form>
        </CardContent>
