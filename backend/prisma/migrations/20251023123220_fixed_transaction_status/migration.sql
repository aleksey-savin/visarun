/*
  ...
  - The values [details_sended] on the enum `TransactionStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."TransactionStatus_new" AS ENUM ('draft', 'details_sent', 'check_uploaded', 'paid_uninformed', 'paid_informed', 'complited', 'cancelled');
